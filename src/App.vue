<template>
  <div id="app">
              ...
              <div class="max-w-max-content lg:max-w-7xl mx-auto">
                <div class="relative z-10 mb-8 md:mb-2 md:px-6">
                  <div class="text-base max-w-prose lg:max-w-none">
                    <p class="leading-6 text-indigo-600 font-semibold tracking-wide uppercase">Voting</p>
                    <h1 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">Which is your favourite Donut?</h1>
                  </div>
                </div>
                <div class="relative">
                      ...
                      <div class="text-gray-500 mb-6 lg:max-w-none lg:mb-0">
                        <div>
                          <div class="mt-5 grid grid-cols-1 gap-5 mx-auto">
                             <button v-for="candidate in candidates" v-bind:key="candidate.id" @click="castVote(candidate.id)" class="w-">
                                <div class="bg-white overflow-hidden shadow rounded-lg">
                                  <div class="p-2">
                                    <div class="flex items-start">
                                      <div class="flex-shrink-0">
                                        <img :src=candidate.image alt="" style="max-width: 100px" class="rounded-md">
                                      </div>
                                      <div class="ml-5 w-0 flex-1 text-left">
                                        ...
                                        <div class="text-3xl leading-9 font-semibold text-gray-900">
                                          {{ candidate.votes }} <small>votes</small>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
    ...
    <div class="bg-white">
      <div class="max-w-screen-xl mx-auto pb-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        <div class="mt-8 md:mt-0 md:order-1">
          <p class="text-center text-xs text-gray-400">
            Akshansh Khare © 2020. All rights reserved.
          </p>
        </div>
      </div>
    </div>
